...
router.get('/getStatusList', (req, res) => {
    const sql_push = $sql.push.select_name;
    conn.query(sql_push, function(err, result) {
        if (err) {
            console.log(err)
        } else {
            jsonWrite(res, result);
...
router.post('/updateStatusList', (req,res) => {
    console.log('updateStatusList',req.body)
    const sql_push = `${$sql.push.update_status} status_id='${req.body.status_id}' where id = '${req.body.id}'`;
    console.log('sql_push',sql_push)
    conn.query(sql_push, function(err, result) {
        if (err) {
            console.log(err)
        } else {
